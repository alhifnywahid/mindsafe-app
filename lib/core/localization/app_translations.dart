...
class AppTranslations extends Translations {
  ...
  static const Map<String, String> enUS = {
    ...
    'history_chart_activity': 'Activity',
    'history_no_data': 'No data for this period',
    'history_stat_duration': 'Duration',
    'history_stat_dangerous': '% Unsafe',
    'history_stat_peak_hour': 'Peak Hour',
  ...
  static const Map<String, String> idID = {
    ...
    'history_chart_activity': 'Aktivitas',
    'history_no_data': 'Tidak ada data pada periode ini',
    'history_stat_duration': 'Durasi',
    'history_stat_dangerous': '% Berbahaya',
    'history_stat_peak_hour': 'Jam Tersibuk',
    ...
    'admin_select_category': 'Pilih Kategori',
